...
class SendCurrentLocationAfterAcceptUseCase @Inject constructor(
    ...
    suspend fun invoke(latLong: LatLong): Response<ResponseUpdateLocation> {
        return try {
            ...
            val response = bookingRepository.updateCurrentLocationAfterAccept(UpdateLocation(latLong, userDto.username!!))
