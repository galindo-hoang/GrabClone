...
object Constant {
    const val REFRESH_TOKEN_EXPIRED_PUT_EXTRA_USERNAME: String = "REFRESH_TOKEN_EXPIRED_PUT_EXTRA_USERNAME"
    const val REFRESH_TOKEN_EXPIRED: String = "REFRESH_TOKEN_EXPIRED"
