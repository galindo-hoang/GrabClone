...
function SideNav(props: Props) {
  ...
  return (
    <Nav className={closeSideNav ? "close" : ""}>
      <NavLink  exact to={checkAccessToken()?PATH.HOME:PATH.LOGIN}>
      </NavLink>
      <Menu className="list-unstyled mb-5 mt-3">
        ...
        <li>
          <NavLink to={checkAccessToken()?PATH.PRODUCT:PATH.LOGIN}>
            <img src={list} alt=""/>
            <span>Sản phẩm</span>
          </NavLink>
        </li>
        <li>
          <NavLink to={checkAccessToken()?PATH.BOOKINGCAR:PATH.LOGIN}>
            <img src={call} alt=""/>
            <span>Đặt xe</span>
          </NavLink>
        </li>
        <li>
          <NavLink to={checkAccessToken()?PATH.HISTORY:PATH.LOGIN}>
            <img src={list} alt=""/>
